...
Current working version: `v0.83 - Word Order Completion Pass`.

Current runtime baseline: `v0.83 - Word Order Completion Pass`.

Next planned patch: `v0.84 - Connectors Completion Pass`

Current README: `README-v0_83.md`

Current changelog: `CHANGELOG-v0_83.txt`

Current source brief: `docs/OZMOSIS_SOURCE_BRIEF_v0.83.md`

Current roadmap: `docs/OZMOSIS_DEVELOPMENT_ROADMAP_v0.83.md`
