...
Current working version: `v0.60`

Next planned patch: `v0.61 - Error Pattern QA / Weakness Repair Preparation`

Current README: `README-v0_60.md`

Current changelog: `CHANGELOG-v0_60.txt`

Current source brief: `docs/OZMOSIS_SOURCE_BRIEF_v0.60.md`

Current roadmap: `docs/OZMOSIS_DEVELOPMENT_ROADMAP_v0.60.md`
