# Ozmosis B1-07 — Codex Import Plan v0.1
...
| --- | --- | --- | --- | --- |
| ozmosis_b1_m07_meetings_leave_requests_schema_mapping_v0_1.md | Yes | Controlling schema mapping | High | Import-planning source. |
| ozmosis_b1_m07_meetings_leave_requests_final_inventory_v0_1.md | Yes | Row counts / clean inventory | High | No row discrepancies. |
...
`READY_FOR_B1_07_CODEX_IMPLEMENTATION_PROMPT`
...
| --- | --- | --- |
| sequential patch for B1-07 | Use when implementing this module | Small, reversible module import. |
...
| B1 module registry | whether B1-07 route/module exists | Yes |
...
| --- | --- | --- | --- | --- |
| draft_b1_07_001 | notice | TF-B1-07-LS07-01 | excluded | import only after current app inspection and route QA |
| draft_b1_07_002 | notice | TF-B1-07-LS06-01 | excluded | import only after current app inspection and route QA |
| draft_b1_07_003 | notice | TF-B1-07-LS04-01 | excluded | import only after current app inspection and route QA |
| draft_b1_07_004 | Auswahl | TF-B1-07-LS08-01 | auto_supported | import only after current app inspection and route QA |
| draft_b1_07_005 | Auswahl | TF-B1-07-LS07-01 | auto_supported | import only after current app inspection and route QA |
| draft_b1_07_006 | Luecke | TF-B1-07-LS07-01 | auto_core | import only after current app inspection and route QA |
| draft_b1_07_007 | Luecke | TF-B1-07-LS07-01 | auto_core | import only after current app inspection and route QA |
| draft_b1_07_008 | Luecke | TF-B1-07-LS06-01 | auto_core | import only after current app inspection and route QA |
| draft_b1_07_009 | Luecke | TF-B1-07-LS04-01 | auto_core | import only after current app inspection and route QA |
| draft_b1_07_010 | Luecke | TF-B1-07-LS03-01 | auto_core | import only after current app inspection and route QA |
| draft_b1_07_011 | Satzbau | TF-B1-07-LS07-01 | auto_core | import only after current app inspection and route QA |
| draft_b1_07_012 | Satzbau | TF-B1-07-LS04-01 | auto_core | import only after current app inspection and route QA |
| draft_b1_07_013 | Satzbau | TF-B1-07-LS06-01 | auto_core | import only after current app inspection and route QA |
| draft_b1_07_014 | Reparatur | TF-B1-07-LS06-01 | auto_core | import only after current app inspection and route QA |
| draft_b1_07_015 | Reparatur | TF-B1-07-LS07-01 | auto_supported | import only after current app inspection and route QA |
| draft_b1_07_016 | Reparatur | TF-B1-07-LS04-01 | auto_core | import only after current app inspection and route QA |
| draft_b1_07_017 | Kontrast | TF-B1-07-LS07-01 | auto_supported | import only after current app inspection and route QA |
| draft_b1_07_018 | Kontrast | TF-B1-07-LS06-01 | auto_supported | import only after current app inspection and route QA |
| draft_b1_07_019 | Produktion | TF-B1-07-LS10-01 | self_marked_production | import only after current app inspection and route QA |
| draft_b1_07_020 | Produktion | TF-B1-07-LS10-01 | self_marked_production | import only after current app inspection and route QA |
...
| --- | --- | --- |
| Route placement | Add to B1-07 module practice route first. | No |
...
First import should prioritise B1-07 module practice route. Do not flood Today’s B1 Sprint. Do not create scheduler/spacing logic in this patch.
...
| Route smoke | B1-07 route starts |
...
Exact next recommended action: after user approval, write a narrow Codex implementation prompt for B1-07 only.
