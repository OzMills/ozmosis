...
The next work should be Skill Matrix QA. Do not implement broader error-pattern detection, weakness repair, delayed review, B2 content, scheduling, or new learner-facing progress states early.
