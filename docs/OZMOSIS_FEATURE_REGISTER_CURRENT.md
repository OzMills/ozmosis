...
| connectors_completion | Connectors Completion | Current roadmap | ready next | v0.84 | word-order basis stable and v0.83 browser gate passed | high | yes | v0.84 | Meaning and syntax contrasts. Allowed now as the next implementation patch; do not start any other later feature first. |
