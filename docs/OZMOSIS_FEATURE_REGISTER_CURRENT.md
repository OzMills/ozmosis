...
| phase_2_5_normalisation_addendum_v0_2 | Phase 2.5 normalisation addendum v0.2 | Strategic roadmap, Phase 2.5 audit if present | deferred planning | v0.81.x or v0.82-planning | v0.81 scoped safely | high | planning_only | after v0.81 scope is stable | Needed before broad generation. |
