...
| prepositions_completion | Prepositions Completion | Current roadmap | ready next | v0.82 | v0.81 accepted; Phase 2.5 addendum completed; B1-01 survival audit completed with non-blocking findings | high | yes | v0.82 | Fixed and two-way prepositions. Do not start Word Order in the same patch. |
| word_order_completion | Word Order Completion | Current roadmap | deferred | v0.83 | preposition/case scope stable | high | no | v0.83 | V2, subordinate clauses, connector-driven order. |
